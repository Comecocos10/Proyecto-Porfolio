...
function ProjectsProduct(props) {
    const Products = [
        {   name: 'Lü', 
            ...
            process: 'Laser cutting of cardboard, resin casting and cutting of polystyrene through a heat wire.',
        ...
        {   name: 'Grefusa',
            ...
            MYV: 'Continue innovating nuts and cereal snacks that are chosen by consumers to savor their leisure time.',
            user: 'Consumers of any kind of PipasG',
            material: 'Poly-lactic acid and Silicone.',
            process: 'Extrusion process with a CO₂ injection system',
            conclusion: 'It is a redesign of the Pipas G container, adding the functionality of a shell container and closure systems to prevent the content from coming out. A simple, easy and actionable container with one hand.',
            photoprin: Grefu,
            photodetail: Grefu2,
            photofin: Grefu3,
        },
        {   name: 'Interactive park',
            ...
            conclusion: 'It is a covered park with 3 play areas distributed as follows: The first contains mental games, the second physical games and the third is an area to promote tranquillity and care for the environment, through holograms and devices.',
            photoprin: PInte,
            photodetail: PInte2,
            photofin: PInte3,  
        },
        {   name: 'Bathroom Aqua',
            ...
            process: 'Injection Molding and Bending.',
